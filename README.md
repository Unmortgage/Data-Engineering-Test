...
[SQLite](https://www.sqlite.org/index.html), with whatever libraries or
frameworks are appropriate.  Please note though we’ll need to be able to
replicate and run your solution.
